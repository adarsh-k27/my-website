...
function IconBox ({ icon, text }) {
  return (
    <div className='w-full h-24 px-2 rounded-lg flex justify-center items-center gap-5 bg-lightSideBar dark:bg-white/10 hover:bg-black/25 hover:dark:bg-white/20 '>
