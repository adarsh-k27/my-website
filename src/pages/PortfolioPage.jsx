...
function PortfolioPage () {
  ...
  return (
    <motion.div
      ...
      className='w-screen md:w-full  md:h-auto h-screen mb-1 flex flex-col gap-3 overflow-y-scroll'
    >
      <div className='mt-[3.4rem] md:mt-8 ml-3 md:ml-3'>
        <div className='flex flex-row w-[50%] z-50 items-center justify-center'>
          ...
          <div className='ml-6 hidden md:block'>
            <p className='text-black text-[.68rem] tracking-wider  dark:text-white'>
        ...
        <div className='ml-6 md:hidden mt-3 '>
          <p className='text-black  dark:text-white text-[.68rem] tracking-wider'>
            email:sample@gmail.com, pass:sample, abhinandh0027@gmail.com,1234567{' '}
          </p>
        </div>
      </div>
      <div
